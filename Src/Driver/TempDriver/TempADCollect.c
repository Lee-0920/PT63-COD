...
#define ADC_CHANNELB              ADC_Channel_7

#define GPIO_CHANNELA_PIN         GPIO_Pin_4
#define GPIO_CHANNELA_PORT        GPIOC
#define GPIO_CHANNELB_PIN         GPIO_Pin_7
#define GPIO_CHANNELB_PORT        GPIOA

#define DMA_CHANNELx              DMA_Channel_1
#define DMA_STREAMx               DMA2_Stream2
#define DMA_STREAMx_IRQn          DMA2_Stream2_IRQn
#define DMA_STREAMx_IRQHANDLER    DMA2_Stream2_IRQHandler

static void TempADCollect_RCCConfiguration(void)
{
    RCC_AHB1PeriphClockCmd(ADCx_CHANNELA_GPIO_CLK | ADCx_CHANNELB_GPIO_CLK, ENABLE);
