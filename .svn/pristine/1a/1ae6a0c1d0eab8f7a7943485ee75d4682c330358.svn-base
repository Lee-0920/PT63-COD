...
//AD5175  默认设置标志与参数：4+2*4
#define AD5175_CONTROL_SIGN_FLASH_BASE_ADDR                 (THERMOSTAT_FACTORY_SIGN_FLASH_BASE_ADDR + THERMOSTAT_FACTORY_SIGN_FLASH_LEN)
...
#define AD5175_CONTROL_PARAM_FLASH_LEN                       2
#define AD5175_CONTROL_PARAM_FLASH_LEN_TOTAL          8

//测量LED DAC默认输出参数：4+4
#define LEDDAC_SIGN_FLASH_BASE_ADDR                              (AD5175_CONTROL_PARAM_FLASH_BASE_ADDR + AD5175_CONTROL_PARAM_FLASH_LEN_TOTAL)
...
//扩展AD5175  默认设置标志与参数：4+2*4
#define EXTAD5175_CONTROL_SIGN_FLASH_BASE_ADDR                 (EXTTHERMOSTAT_PARAM_ADDRESS + EXTTHERMOSTAT_PARAM_LEN_TOTAL)
#define EXTAD5175_CONTROL_SIGN_FLASH_LEN                       4
#define EXTAD5175_CONTROL_PARAM_FLASH_BASE_ADDR                 (EXTAD5175_CONTROL_SIGN_FLASH_BASE_ADDR + EXTAD5175_CONTROL_SIGN_FLASH_LEN)
#define EXTAD5175_CONTROL_PARAM_FLASH_LEN                       2
#define EXTAD5175_CONTROL_PARAM_FLASH_LEN_TOTAL          8

#define METER_OVER_VALVE_FLASH_BASE_ADDR                 (EXTAD5175_CONTROL_PARAM_FLASH_BASE_ADDR + EXTAD5175_CONTROL_PARAM_FLASH_LEN_TOTAL)
