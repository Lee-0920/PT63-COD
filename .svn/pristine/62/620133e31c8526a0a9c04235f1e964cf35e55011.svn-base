...
// CS
#define AD7791_CS_PIN           GPIO_Pin_12
#define AD7791_CS_GPIO          GPIOB
#define AD7791_CS_RCC           RCC_AHB1Periph_GPIOB
...
// SCLK
#define AD7791_SCLK_PIN         GPIO_Pin_13
#define AD7791_SCLK_GPIO        GPIOB
#define AD7791_SCLK_RCC         RCC_AHB1Periph_GPIOB
...
// DIN
#define AD7791_DIN_PIN          GPIO_Pin_15
#define AD7791_DIN_GPIO         GPIOB
#define AD7791_DIN_RCC          RCC_AHB1Periph_GPIOB
...
// DOUT
#define AD7791_DOUT_PIN         GPIO_Pin_14
#define AD7791_DOUT_GPIO        GPIOB
#define AD7791_DOUT_RCC         RCC_AHB1Periph_GPIOB
...
void OpticalADCollect_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = IGL_RESET_PIN;
    GPIO_Init(IGL_RESET_PORT, &GPIO_InitStructure);
    IGL_CTRL_HIGH();

    GPIO_InitStructure.GPIO_Pin = IGL_CTRL_PIN;
    GPIO_Init(IGL_CTRL_PORT, &GPIO_InitStructure);
    IGL_RESET_HIGH();
