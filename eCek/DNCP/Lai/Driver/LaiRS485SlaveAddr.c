...
#define LAIRS485SLAVEADDR_ADR0_RCC       RCC_AHB1Periph_GPIOE
#define LAIRS485SLAVEADDR_ADR0_PORT      GPIOE
#define LAIRS485SlAVEADDR_ADR0_PIN       GPIO_Pin_3

#define LAIRS485SLAVEADDR_ADR1_RCC       RCC_AHB1Periph_GPIOE
#define LAIRS485SLAVEADDR_ADR1_PORT      GPIOE
#define LAIRS485SlAVEADDR_ADR1_PIN       GPIO_Pin_4
...
void LaiRS485SlaveAddr_GPIOConfig(void)
{
    ...
    RCC_AHB1PeriphClockCmd(
            LAIRS485SLAVEADDR_ADR0_RCC | LAIRS485SLAVEADDR_ADR1_RCC
                    /*| LAIRS485SLAVEADDR_ADR2_RCC | LAIRS485SLAVEADDR_ADR3_RCC*/,
            ENABLE);
